 ...
 * @author user
 */
public class GeoFenceReport extends GenericReport implements Serializable {
    ...
    public JasperPrint getReport(ArrayList<ReportObj> val, String companyId, Integer branchId, ArrayList<Integer> selectedClientIds, ArrayList<Integer> selectedEmployeeIds, String language) {
        ...
        InputStream reportStream = ReportLookupClass.class.getResourceAsStream("GeoFenceReport.jasper");
        ...
        try {
            ...
            try {
                ...
                try {
                    clientBranch = companyService.getBranchById(myClient.getBranchId());
                } catch (Exception exe) {
                    try {
        ...
        try {
            ...
            try {
                hm.put("client_id", this.getClientId());
            } catch (Exception exe) {
                hm.put("client_id", -1);
            }
    ...
    public String getReportName() {
        Locale locale = FacesContext.getCurrentInstance().getViewRoot().getLocale();
        ResourceBundle rb = ResourceBundle.getBundle("PatrolPro", locale);
        return rb.getString("geoFenceReport");
    }
