 ...
 * @author ira
 */
public class GenerateODRFileServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OfficerDailyReportService oService = new OfficerDailyReportService(companyId);
            //oService.getDailyReportsForClientWithText(clientId, 60, false);
